...
async function getHiddenPostsForUser(userId: string, searchQuery?: string) {
...
export default async function HiddenPostsPage({ searchParams }: { searchParams: { [key: string]: string | string[] | undefined }}) {
    ...
    const posts = await getHiddenPostsForUser(userId, q);
